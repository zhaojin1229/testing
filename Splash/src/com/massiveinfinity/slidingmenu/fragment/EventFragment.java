...
//	final ArrayList<HashMap<String, Object>> faqlist = new ArrayList<HashMap<String, Object>>();
    ...
    public EventFragment(String text) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		{
    	    view = inflater.inflate(R.layout.event_page, null);
		}
		        ...
		        final Handler handler1 = new Handler() {
					...
					Thread checkUpdate = new Thread() {  
					   public void run() {
						   ...
						   String url="https://ndp2013api.azure-mobile.net/tables/Event?$top=1000";
						   try {
...
//				});
    ...
    private Dialog getInstanceMyDialog2(final int p) {
        final Dialog d= new Dialog(getActivity());
        d.requestWindowFeature(Window.FEATURE_NO_TITLE);
        if(SlidingActivity.width>720&&SlidingActivity.screenInches>6)
		{
        	d.setContentView(R.layout.eventdialog_l);
		}
		else
		{
 //   	    view = inflater.inflate(R.layout.about_scoll_page, null);
        d.setContentView(R.layout.eventdialog);
        
		}
        Button map=(Button) d.findViewById(R.id.button1);
        map.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 Intent i=new Intent(getActivity(),com.massiveinfinity.slidingmenu.EventMap.class);
	        	 String title=mainlist.get(p).get("title").toString();
	        	 i.putExtra("title", title);
	        	 i.putExtra("whole", mainlist.get(p));
                	startActivity(i);
