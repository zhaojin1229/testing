...
public class LazyAdapterVideo extends BaseAdapter {
   ...
   // Animation animation,animation3,animation2,animation4,animation5,animation6,animation7,animation8;
    ...
    public LazyAdapterVideo(Activity a, ArrayList<HashMap<String,Object>> a1) {
...
//      imageLoader3=new ImageLoader3(activity.getApplicationContext());  }
    ...
    public LazyAdapterVideo(Activity a, String[] d) {
    	activity=a;
        people=d;
        inflater = (LayoutInflater)a.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        imageLoader=new ImageLoader(a.getApplicationContext());
...
//    	imageLoader.clearCache();
        ...
        if(convertView==null)
    		...
    		{
        		 vi = inflater.inflate(R.layout.videorows1_l, null);
    		}
    		else
    		{
    			 vi = inflater.inflate(R.layout.videorows1, null);
    		}
        ...
        i=(ImageView) vi.findViewById(R.id.imageButton1);
