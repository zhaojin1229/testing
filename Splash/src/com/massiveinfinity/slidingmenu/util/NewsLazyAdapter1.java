...
public class NewsLazyAdapter1 extends BaseAdapter {
   ...
   // Animation animation,animation3,animation2,animation4,animation5,animation6,animation7,animation8;
    ...
    public NewsLazyAdapter1(Activity a, ArrayList<HashMap<String,Object>> a1) {
...
//      imageLoader3=new ImageLoader3(activity.getApplicationContext());  }
    ...
    public NewsLazyAdapter1(Activity a, String[] d) {
    	activity=a;
        people=d;
        inflater = (LayoutInflater)a.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        imageLoader=new ImageLoader(a.getApplicationContext());
...
//    	imageLoader.clearCache();
        ...
        if(convertView==null)
    		...
    		{
        	       vi = inflater.inflate(R.layout.news_rows_l, null);
    		}
    		else
    		{
        ...
        TextView t1,t2; 
        ImageView i=(ImageView) vi.findViewById(R.id.imageButton1);
        imageLoader.DisplayImage(h.get("image").toString(), i);
        t1=(TextView)vi.findViewById(R.id.ndp);
        t2=(TextView)vi.findViewById(R.id.title);
       
        
        t1.setText((String)h.get("title"));
        t2.setText((String)h.get("des"));
