...
public class LazyAdapterPhotos extends BaseAdapter {
   ...
   // Animation animation,animation3,animation2,animation4,animation5,animation6,animation7,animation8;
    ...
    public LazyAdapterPhotos(Activity a, ArrayList<HashMap<String,Object>> a1) {
 
  	  activity = a;
  	  menuItems=a1;
      inflater = (LayoutInflater)a.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
      imageLoader=new ImageLoader(a.getApplicationContext());
      PhotoFragment.i=new ImageLoader(a.getApplicationContext());
    }
//      imageLoader3=new ImageLoader3(activity.getApplicationContext());  }
    
    public LazyAdapterPhotos(Activity a, String[] d) {
    	activity=a;
        people=d;
        inflater = (LayoutInflater)a.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        imageLoader=new ImageLoader(a.getApplicationContext());
...
//    	imageLoader.clearCache();
        ...
        if(convertView==null)
    		...
    		{
        		vi = inflater.inflate(R.layout.photorows_l, null);
    		}
    		else
    		{
    			vi = inflater.inflate(R.layout.photorows, null);
    		}
        
        
        final HashMap<String, Object> h=menuItems.get(position);
        TextView t1,t2; 
        ImageView image=(ImageView) vi.findViewById(R.id.imageButton1);
        t1=(TextView)vi.findViewById(R.id.ndp);
        t2=(TextView)vi.findViewById(R.id.title);
        PhotoFragment.i.DisplayImage(h.get("image").toString(), image);
        
        t1.setText((String)h.get("title"));
        t2.setText((String)h.get("des1"));
